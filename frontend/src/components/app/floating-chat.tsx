    ...
    <>
      ...
      >
        <div className="px-4 py-3 border-b border-white/10 flex items-center gap-2">
          <div className="grid place-items-center h-7 w-7 rounded-lg bg-gradient-primary"><Sparkles className="h-3.5 w-3.5 text-white" /></div>
          <div>
        ...
        <form onSubmit={send} className="p-3 border-t border-white/10 flex gap-2">
          <Input value={input} onChange={(e) => setInput(e.target.value)} placeholder="Ask DeadlinePilot…" className="glass border-white/10" />
