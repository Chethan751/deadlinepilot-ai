...
const FEATURES = [
  {
    icon: Sparkles,
    title: "AI Planner",
    desc: "Brain-dump in plain English. Gemini extracts every task, estimates time, sets priority.",
  },
  {
    icon: ListChecks,
    title: "Smart Tasks",
    desc: "Each task ranked by urgency, risk, and deadline pressure — updated live.",
  },
  {
    icon: Timer,
    title: "Focus Mode",
    desc: "Built-in Pomodoro timer logs every deep work session automatically.",
  },
  {
    icon: MessageCircle,
    title: "AI Coach",
    desc: "Ask anytime: 'what should I do now?' Get a clear, motivating answer.",
  },
  {
    icon: BarChart3,
    title: "Analytics",
    desc: "See your completion patterns, streaks, and where you tend to stall.",
  },
  {
    icon: Zap,
    title: "Autonomous",
    desc: "Not a reminder app. DeadlinePilot decides what matters next, for you.",
  },
];
    ...
    <div className="relative min-h-screen">
      ...
      <section className="px-6 pt-12 pb-20 max-w-5xl mx-auto text-center">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full glass border-white/10 text-xs text-muted-foreground mb-6"
        >
        ...
        >
          DeadlinePilot is an autonomous AI companion that plans, prioritizes, and pushes you across
          the finish line — before the deadline becomes a regret.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <Link to="/auth">
            <Button
              size="lg"
              className="bg-gradient-primary text-white shadow-[var(--shadow-glow)] text-base h-12 px-7"
            >
          ...
          <Link to="/auth">
            <Button
              size="lg"
              variant="outline"
              className="glass border-white/10 text-base h-12 px-7"
            >
              See it in action
            </Button>
          </Link>
            ...
            return (
              ...
              >
                <GlassCard className="h-full">
                  <div className="h-10 w-10 rounded-xl bg-gradient-primary grid place-items-center mb-3">
      ...
      <section className="px-6 pb-24 max-w-4xl mx-auto">
        <GlassCard className="p-10 text-center bg-gradient-to-br from-primary/10 to-secondary/10">
          ...
          <Link to="/auth">
            <Button
              size="lg"
              className="mt-6 bg-gradient-primary text-white shadow-[var(--shadow-glow)]"
            >
              Take the controls →
            </Button>
          </Link>
